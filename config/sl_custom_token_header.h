...
#define CURRENT_LEVEL_DEFAULT    0xFE

#define CREATOR_CURRENT_LEVEL 0xB020
#define NVM3KEY_CURRENT_LEVEL (NVM3KEY_DOMAIN_ZIGBEE | 0xB020)

#ifdef DEFINETOKENS
    DEFINE_INDEXED_TOKEN(CURRENT_LEVEL,
                         uint8_t,
                         APP_EP_COUNT,
